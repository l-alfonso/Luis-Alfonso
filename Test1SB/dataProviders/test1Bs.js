...
(function() {
    var provider = app.data.test1Bs = new Everlive({
            offlineStorage: true,
            apiKey: '2CTjN7lFAXTmqwnO',
    ...
    document.addEventListener('online', function() {
        app.data.test1Bs.offline(false);
        app.data.test1Bs.sync();
    });

    document.addEventListener('offline', function() {
        app.data.test1Bs.offline(true);
    });

}());

// START_CUSTOM_CODE_test1Bs
// END_CUSTOM_CODE_test1Bs